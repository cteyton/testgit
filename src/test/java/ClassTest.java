...
//        assertEquals(4, new ClassFull().division(8, 2));
    ...
    public void testFull4() {
        assertEquals(2, new ClassFull().multiplication2(1, 2));
    }

    @Test
    public void testFull5() {
        assertEquals(2, new ClassFull().multiplication3(1, 2));
    }

    @Test
    public void testFull6() {
        assertEquals(2, new ClassFull().multiplication4(1, 2));
    }

    @Test
    public void testFull7() {
        assertEquals(2, new ClassFull().multiplication5(1, 2));
    }

    @Test
    public void testFull8() {
        assertEquals(2, new ClassFull().multiplication6(1, 2));
    }

    @Test
    public void testFull9() {
        assertEquals(2, new ClassFull().multiplication7(1, 2));
    }

    @Test
    public void testFull10() {
        assertEquals(2, new ClassFull().multiplication8(1, 2));
    }

    @Test
    public void testFull11() {
        assertEquals(2, new ClassFull().multiplication9(1, 2));
    }

    @Test
    public void testFull12() {
        assertEquals(2, new ClassFull().multiplication10(1, 2));
    }

    @Test
    public void testFull13() {
        assertEquals(2, new ClassFull().multiplication11(1, 2));
    }
